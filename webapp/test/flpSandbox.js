		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "KPO Supplier Portal",
									"targetURL": "#comsapsupplierportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsupplierportal-display": {
								"semanticObject": "comsapsupplierportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.supplierportal",
									"url": sap.ui.require.toUrl("com/sap/supplierportal")
								}
							}
						}
					}
